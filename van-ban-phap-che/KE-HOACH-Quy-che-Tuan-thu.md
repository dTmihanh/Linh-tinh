...
```mermaid
flowchart TD
  Owner[TongCuc_CNQP_BQP] -->|Giam_sat_chu_so_huu| Leadership[ChuTich_GiamDoc]
  Leadership --> Line1[Tuyen1_PhongBan_PhanXuong]
  Leadership --> Line2[Tuyen2_PhapChe]
  Line1 -->|Tu_tuan_thu_bao_cao| Line2
  Line2 -->|Tham_muu_bao_cao| Leadership
  Line2 -->|Dau_moi_phap_ly| External[Doan_kiem_tra_ben_ngoai]
  subgraph phapCheDoc [Quy_dinh_Phap_che]
    RolePC[Chuc_nang_nhiem_vu_quyen_han]
  end
  subgraph tuanThuDoc [Quy_che_Tuan_thu]
    SystemTT[He_thong_quy_trinh_nghia_vu]
  end
  RolePC -->|Chu_tri| SystemTT
```
